...
Guidance for Claude Code (and any AI agent) working in the `infra/` directory of the Urban Policy Simulation. Read this before writing code here.
...
- Docker compose, CI/CD pipelines, Kubernetes manifests, terraform files, and environment definitions.
