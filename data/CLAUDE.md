# CLAUDE.md — Data Subsystem

Guidance for Claude Code (and any AI agent) working in the `data/` directory of the Urban Policy Simulation. Read this before writing code here.
