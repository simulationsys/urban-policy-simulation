# CLAUDE.md — Simulation Core

Guidance for Claude Code (and any AI agent) working in the `simulation/` directory of the Urban Policy Simulation. Read this before writing code here.
...
- Simulation core models, agents, environments, solvers, and test suites.
